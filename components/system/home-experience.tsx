...
type CaptureMode = "Write" | "Voice" | "Photo" | "Screenshot";
...
export function HomeExperience() {
  ...
  const selectDestination = (destination: Destination) => {
    ...
    setNotice(`${destination} will be shaped in the next milestone.`);
        ...
        <div className="home-layout">
          <section className="interview-column" aria-labelledby="today-question">
                ...
                {captureModes.map(({ label, icon: Icon }) => (
                  <button
                    ...
                    onClick={() => {
                      ...
                      setInterviewStarted(false);
                      if (label !== "Write") {
                        setNotice(`${label} capture is selected for the Add Memory milestone.`);
                        window.setTimeout(() => setNotice(null), 2600);
                      }
                    }}
                  >
            ...
            <AnimatePresence>
              {interviewStarted ? (
                <motion.article
                  className="follow-up-sheet"
                  initial={{ opacity: 0, y: reduceMotion ? 0 : 18, rotate: reduceMotion ? 0 : -0.4 }}
                ...
                >
                  <div className="follow-up-heading">
                    ...
                    <span>There&apos;s something worth keeping here.</span>
                  </div>
                  <p>What exactly did they notice—and why did hearing it matter to you?</p>
                  <div className="follow-up-actions">
                    <button type="button" onClick={focusComposer}>Answer in your own words</button>
                    <button type="button" onClick={() => setNotice("Saved as a beginning. You can return whenever you like.")}>Save this beginning</button>
                  </div>
                </motion.article>
              ) : null}
            </AnimatePresence>
            ...
            <section className="book-section">
              ...
              <article className="book-cover-card">
                <div className="book-cover-image">
                  <Image
                    src="/assets/seaside-memory.png"
                    alt="A quiet coast at the edge of the sea"
                    fill
            ...
            <section className="recent-section">
              ...
              <article className="recent-page">
                <div className="recent-page-image">
                  <Image
                    src="/assets/domestic-still-life.png"
                    alt="A warm still life near a kitchen window"
                    fill
                    sizes="120px"
                  />
                </div>
